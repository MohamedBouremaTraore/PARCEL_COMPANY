        ...
        <div class="row flex-nowrap">
            ...
            <div class="col">
                ...
                <section>
                 ...
                 <form action="{{url('/handle_changer_etat/livreur')}}" class="row shadow-lg" style="padding:20px;margin:20px" id="ramassage">
                    <div class="row">
                   ...
                   <div class="row" style="padding: 10px 10px;">
                    <select class="form-select" aria-label="Default select example" name="etat">
                        ...
                        <option value="En cour de livraison">En cour de livraison</option>
