            ...
            <section class="">  
              <div class="row" style="height:80px;">
               <div class="d-flex flex-row-reverse bd-highlight">
                ...
                <section>
                    <a href="{{url('/deliver/'.$users[0]->id)}}">   <div class="row border-3 border-top border-bottom  bg-light text-center">
                                
                                    <h5>Liste des colis à expedier</h5>
                          ...
                          <div class="container-fluid">
                           <form class="d-flex" action="{{url('/rechercher')}}">
                               <div class="row">
                                ...
                                <input type="hidden" id="type" name="type" value="livreur">
        ...
        <table class="table table-bordered">
            <thead>
              <tr>
                ...
                <th scope="col">Reference<i class="fa fa-sort" aria-hidden="true"></i></th>
            ...
            <tbody>
                ...
                <tr>
                    <td><a href="{{url('/editer/livreur/'.$users[0]->id.'/'.$coli->id)}}"><div class="btn btn-primary">Editer</div></a></td>
