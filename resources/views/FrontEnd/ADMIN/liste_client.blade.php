               ...
               <div class="d-flex flex-row-reverse bd-highlight">
                ...
                <section>
                        <div class="row border-3 border-top border-bottom  bg-white">
                          <div class="col col-2 " href="#"><a class="nav-link link-secondary bg-light" href="{{url('/nouveau_colis/'.$users[0]->id)}}"><h5>Liste des clients</h5> </a></div>
                         </div>
                </section>
                        ...
                        <div class="container-fluid">
                         <form class="d-flex" action="{{url('/rechercher')}}">
                             <div class="row">
                              ...
                              <input type="hidden" id="type" name="type" value="liste_client">
