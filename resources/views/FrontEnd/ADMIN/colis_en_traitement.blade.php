               ...
               <div class="d-flex flex-row-reverse bd-highlight">
                ...
                <section>
                        <div class="row border-3 border-top border-bottom  bg-white">
                            <div class="col col-2 " href="#"><a class="nav-link link-secondary " href="{{url('/nouveau_colis/'.$users[0]->id)}}"><h5>Nouveau Colis</h5> </a></div>
                            <div class="col col-3" href="#"><a class="nav-link link-secondary bg-light"href="{{url('/colis_en_traitement/'.$users[0]->id)}}"><h5>Colis en traitement</h5></a></div>
                          </div>
                </section>
                          ...
                          <div class="container-fluid">
                           <form class="d-flex" action="{{url('/rechercher')}}">
                               <div class="row">
                                ...
                                <input type="hidden" id="type" name="type" value="traitement">
        ...
        <table class="table table-bordered">
            <thead>
              <tr>
                ...
                <th scope="col">Référence<i class="fa fa-sort" aria-hidden="true"></i> </th>
                ...
                <th scope="col">Commentaire<i class="fa fa-sort" aria-hidden="true"></i></th>
              </tr>
            </thead>
            <tbody>
                ...
                <tr>
                    <th scope="row"><a href="{{url('/editer/'.$users[0]->id).'/'.$coli->id}}" class="btn btn-primary">Editer</a></th>
                    <th scope="row">{{$coli->id}}</th>
                    <td>{{$coli->reference}}</td>
                    <td>{{$coli->destinateur}}</td>
                    <td>{{$coli->ville}}</td>
                    <td>{{$coli->prix}} dh</td>
                    <td class="text-center"><span style="background-color:green;
