               ...
               <div class="d-flex flex-row-reverse bd-highlight">
                ...
                <section>
                        <div class="row border-3 border-top border-bottom  bg-white">
                          <div class="col col-3 " href="#"><a class="nav-link link-secondary bg-light" href="{{url('/nouveau_colis/'.$users[0]->id)}}"><h5>Ajouter Nouveau Client</h5> </a></div>
                </section>
...
<section>
    <form action="{{url('add_client/'.$users[0]->id)}}" >
