               ...
               <div class="d-flex flex-row-reverse bd-highlight">
                ...
                <section>
                        <div class="row border-3 border-top border-bottom  bg-white">
                          ...
                          <div class="col col-3 bg-light" href="#"><a class="nav-link link-secondary "href="{{url('/liste_livraison/'.$users[0]->id)}}"><h5>Liste livraison (<span class="text-danger">{{$nbre_livraison}}</span>)</h5></a></div>
                      </div>
                </section>
                          ...
                          <div class="container-fluid">
                           <form class="d-flex" action="{{url('/rechercher')}}">
                               <div class="row">
                                ...
                                <input type="hidden" id="type" name="type" value="ramassage">
     ...
     <div class="row">
        <table class="table table-bordered">
            ...
            <tbody>
                ...
                <tr>
                    <td><a class="btn btn-primary" href="#">Editer</a></td>
