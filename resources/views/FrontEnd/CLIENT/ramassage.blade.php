               ...
               <div class="d-flex flex-row-reverse bd-highlight">
                ...
                <section>
                        <div class="row border-3 border-top border-bottom  bg-white">
                          <div class="col col-2 bg-light" href="#"><a class="nav-link link-secondary active" href="{{url('/ramassage/'.$users[0]->id)}}"><h5>Ramassage</h5> </a></div>
