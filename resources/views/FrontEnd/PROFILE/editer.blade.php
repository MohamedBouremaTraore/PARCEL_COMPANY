            ...
            <div class="col">
                ...
                <section class="row shadow-lg" style="padding:20px;margin:20px">
                    ...
                    <div class="row" style="padding: 20px 10px;">
                       <a href="{{url('/delete/'.$users[0]->id.'/'.$id_colis)}}" class="btn btn-danger" style="">
                    ...
                    <div class="row" style="padding: 20px 10px;">
                       <a href="{{url('/update/'.$users[0]->id.'/'.$id_colis)}}" class="btn btn-primary" style="">
                           <span style="color: white">
                    ...
                    <div class="row" style="padding: 20px 10px;">
                       <a href="{{url('/choose_livreur/'.$users[0]->id.'/'.$id_colis)}}" class="btn btn-primary" style="">
                           <span style="color: white">
                                Choisir un livreur
                           </span>
                        </a>
                   ...
                   <div class="row" style="padding: 20px 10px;">
                    <a href="{{url('/changer_etat/'.$users[0]->id.'/'.$id_colis)}}" class="btn btn-primary" style="">
                        <span style="color: white">
                             Changer état
                        </span>
                     </a>
