        ...
        <div class="row flex-nowrap">
            ...
            <div class="col">
                ...
                <section>
                 ...
                 <form action="{{url('/replace_password')}}" class="row shadow-lg" style="padding:20px;margin:20px" id="ramassage">
                    <div class="row">
                   ...
                   <div class="row" style="padding: 10px 10px;">
                    <label for="staticEmail" class="col col-form-label">Nouveau mot de passe</label>
                     <input type="text" class="form-control" id="staticEmail" value="" name="new_password">
                   </div>
               
                 
                   <div class="row">
                    <label for="inputPassword" class="col col-form-label">Confirmer mot de passe</label>
                     <input type="text" class="form-control" id="inputPassword" name="confirm_password">
                  </div>
