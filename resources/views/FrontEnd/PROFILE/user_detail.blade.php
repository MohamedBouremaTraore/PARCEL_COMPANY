        ...
        <div class="row flex-nowrap">
            ...
            <div class="col">
                ...
                <section>
                 ...
                 <div class="row shadow-lg" style="padding:15px;margin :20px" id="ramassage">
                   ...
                   <div class="row">
                       <span>Username</h5> : <span>{{$users[0]->username}}</span>
                   </div>
                   <div class="row">
                    <span>Email</h5> : <span>{{$users[0]->email}}</span>
                </div>
                <div class="row">
                    <span>Mots de passe </h5> : <span>{{$users[0]->password}}</span>
                </div>
                <div class="row">
                    <span>Code</h5> : <span>{{$users[0]->id}}</span>
                </div>
                <div class="row">
                    <span>Nom commercial</h5> : <span>{{$users[0]->username}}</span>
                </div>
